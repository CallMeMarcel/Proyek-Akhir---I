...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html"><span class="flaticon-bible"></span> hcrbc</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="#services-section" class="nav-link"><span>Doctrine</span></a></li>
	          ...
	          <li class="nav-item"><a href="#pastor-section" class="nav-link"><span>Elders</span></a></li>
	          <li class="nav-item"><a href="#contact-section" class="nav-link"><span>Contact</span></a></li>
            <li class="nav-item"><a href="#photo-section" class="nav-link"><span>Photos</span></a></li>
	        </ul>
	      </div>
	    </div>
    </nav>
	          ...
	          <div class="col-md-8 text-center ftco-animate mt-5">
	          	<div class="text">
	          		<div class="subheading">
	          			<span>Hill City Reformed Baptist Church</span>
	          		</div>
	        ...
	        <div class="container">
	          ...
	          <div class="col-md-8 text-center ftco-animate mt-5">
	          	<div class="text">
		            ...
		            <h1 class="mb-4">Hill City Reformed <span>Baptist Church</span></h1>
		            <p>Following Jesus wherever we are.</p>
		            <p><a href="#" class="btn btn-primary py-2 px-4">Be part of us</a> <a href="#about-section" class="btn btn-primary btn-outline-primary py-2 px-4 home-slider">About us</a></p>
	            </div>
	          </div>
	        </div>
        </div>
    	...
    	<div class="container-fluid px-0">
    		<div class="row d-md-flex text-wrapper">
              ...
              <ul class="my-4">
              	...
              	<li><span class="ion-ios-checkmark-circle mr-2"></span> Sed do eiusmod tempor incididunt</li>
              </ul>
            </div>
					</div>
    		</div>
    ...
    <section class="ftco-counter" id="section-counter">
		...
		<section class="ftco-section ftco-services-2" id="services-section">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
          	<span class="subheading">Subtitle 1</span>
            <h2 class="mb-4">Section Title 1</h2>
		...
		<section class="ftco-section bg-light" id="sermons-section">
			<div class="container">
				<div class="row justify-content-center pb-5">
          <div class="col-md-12 heading-section text-center ftco-animate">
          	<span class="subheading">Subtitle 2</span>
            <h2 class="mb-4">HCRBC Sermons</h2>
            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
          </div>
        </div>
				<div class="row">
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(asset/images/sermon-1.jpg);">
        	...
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(asset/images/sermon-2.jpg);">
    						<div class="text-content p-4 text-center">
    							<span>by pastor:</span>
    							<h3>Jerry Simon</h3>
    							<p class="">
        	...
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(asset/images/sermon-3.jpg);">
    						<div class="text-content p-4 text-center">
    							<span>by pastor:</span>
    							<h3>Jerry Simon</h3>
    							<p class="">
        	...
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(asset/images/sermon-4.jpg);">
    						<div class="text-content p-4 text-center">
    							<span>by pastor:</span>
    							<h3>Jerry Simon</h3>
    							<p class="">
        	...
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(asset/images/sermon-5.jpg);">
    						<div class="text-content p-4 text-center">
    							<span>by pastor:</span>
    							<h3>Jerry Simon</h3>
    							<p class="">
        	...
        	<div class="col-md-4">
        		<div class="sermon-wrap ftco-animate">
    					<div class="img d-flex align-items-center justify-content-center" style="background-image: url(asset/images/sermon-6.jpg);">
    						<div class="text-content p-4 text-center">
    							<span>by pastor:</span>
    							<h3>Jerry Simon</h3>
    							<p class="">
		...
		<section class="ftco-section bg-light ftco-event" id="events-section">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
        	...
        	<div class="col-md-12 col-lg-6 col-xl-4">
        		<div class="event-wrap d-flex ftco-animate">
        			<div class="img" style="background-image: url(asset/images/event-2.jpg);"></div>
        			<div class="text p-4 d-flex align-items-center">
        				<div>
	        				<span class="time">8:30am - 11:30am</span>
	        				<h3><a href="#">Sharing Our Faith &amp; Gospel</a></h3>
        	...
        	<div class="col-md-12 col-lg-6 col-xl-4">
        		<div class="event-wrap d-flex ftco-animate">
        			<div class="img" style="background-image: url(asset/images/event-3.jpg);"></div>
        			<div class="text p-4 d-flex align-items-center">
        				<div>
	        				<span class="time">8:30am - 11:30am</span>
	        				<h3><a href="#">Sharing Our Faith &amp; Gospel</a></h3>
        	...
        	<div class="col-md-12 col-lg-6 col-xl-4">
        		<div class="event-wrap d-flex ftco-animate">
        			<div class="img" style="background-image: url(asset/images/event-4.jpg);"></div>
        			<div class="text p-4 d-flex align-items-center">
        				<div>
	        				<span class="time">8:30am - 11:30am</span>
	        				<h3><a href="#">Sharing Our Faith &amp; Gospel</a></h3>
        	...
        	<div class="col-md-12 col-lg-6 col-xl-4">
        		<div class="event-wrap d-flex ftco-animate">
        			<div class="img" style="background-image: url(asset/images/event-5.jpg);"></div>
        			<div class="text p-4 d-flex align-items-center">
        				<div>
	        				<span class="time">8:30am - 11:30am</span>
	        				<h3><a href="#">Sharing Our Faith &amp; Gospel</a></h3>
        	...
        	<div class="col-md-12 col-lg-6 col-xl-4">
        		<div class="event-wrap d-flex ftco-animate">
        			<div class="img" style="background-image: url(asset/images/event-6.jpg);"></div>
        			<div class="text p-4 d-flex align-items-center">
        				<div>
	        				<span class="time">8:30am - 11:30am</span>
	        				<h3><a href="#">Sharing Our Faith &amp; Gospel</a></h3>
    ...
    <section class="ftco-section ftco-no-pb" id="pastor-section">
    	<div class="container">
          ...
          <div class="col-md-6 heading-section text-center ftco-animate">
          	<span class="subheading">Hill City Reformed Baptist Church</span>
            <h2 class="mb-4">Elders</h2>
            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
          </div>
        </div>
        <div class="row">
    ...
    <section class="ftco-section contact-section ftco-no-pb" id="contact-section">
      <div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            <span class="subheading">HCRBC</span>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2 logo"><span>Hill City Reformed </span>Baptist Church</h2>
