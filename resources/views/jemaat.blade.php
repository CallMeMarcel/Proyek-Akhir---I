...
<section class="ftco-intro img" id="events-section" style="background-image: url(asset/images/bg_4.jpg); background-attachment: fixed;">
    ...
    <div class="container-fluid px-4 ftco-to-top">
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="jemaatTable">
                    <!-- Table head -->
                    <thead>
                        <tr style="background-color: #FFD700;">
                            ...
                            <th><h2 class="text-center">Lingkungan</h2></th>
                            <th><h2 class="text-center">Tangal Lahir</h2></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $i=1 ?>
                        @foreach($allJemaat as $item) <!-- Menampilkan hanya 10 data pertama -->
                        <tr>
                            ...
                            <td><h4 class="text-center">{{ $item->lingkungan }}</h4></td>
                            <td><h4 class="text-center">{{ $item->tanggal }}</h4></td>
                        </tr>
                        <?php $i++ ?>
                        @endforeach
                    </tbody>
